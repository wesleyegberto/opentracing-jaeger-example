...
namespace ServiceB {
    public class Startup {
        ...
        public void ConfigureServices(IServiceCollection services) {
            ...
            services.AddHttpClient("serviceC", c => {
                    c.BaseAddress = new Uri("http://localhost:8090/servicec/api/");
                })
                .AddHttpMessageHandler<RequestTracingHandler>();
            services.AddHttpClient("serviceD", c => {
                    c.BaseAddress = new Uri("http://localhost:5050/serviced/api/");
                })
                .AddHttpMessageHandler<RequestTracingHandler>();
